...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "E:\\maestria-cub\\modulo-1\\fs-projectManager\\task-manager-react\\backend\\prisma\\task-manager-react\\backend\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "E:\\maestria-cub\\modulo-1\\fs-projectManager\\task-manager-react\\backend\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "../../..",
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Get a free hosted Postgres database in seconds: `npx create-db`\n\ngenerator client {\n  provider = \"prisma-client\"\n  output   = \"task-manager-react/backend/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Task {\n  id        Int      @id @default(autoincrement())\n  text      String\n  completed Boolean  @default(false)\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "8cb88a06ceb7cc4fa61ec27fd293d9ff6fd8f9a3eb823c5f42fdc03f24b2f08d",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
